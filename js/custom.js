(function ($) {
    ...
    if (document.getElementById("marketsChartBtcLight")) {
        am4core.ready(function () {
            ...
            chart.zoomOutButton.icon.stroke = am4core.color(
                "rgba(0, 0, 0, 0.40)"
            );
    ...
    // make tr linkable
    // $(".markets-pair-list tr, .market-pairs tr").click(function () {
    ...
    var chartsIndiv = document.getElementsByClassName("markets-capital-chart-bar");
